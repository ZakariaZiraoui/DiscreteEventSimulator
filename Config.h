...
#define N 4     //Number of Nodes in X Dimension
#define M 4     //Number of Nodes in Y Dimension
...
#define BatchMeansMethod 0  //1 Use The Batch Means Method
#define Batches 36          //Number of Batches To be Used
        //Note That Batch Size is equal to Max

#define Logging true       //Log  the LifeCycles of Messages
